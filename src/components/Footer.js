      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        <div className="flex flex-col items-center space-y-4">
          <div className="flex items-center space-x-4">
            <span className="text-blue-600 dark:text-blue-400 font-semibold transition-colors duration-200">
              Font Finder
            </span>
            <span className="text-gray-300 dark:text-gray-700">•</span>
            <a 
              href="https://github.com/YeonSeong-Lee/recommend-font" 
              className="text-gray-500 hover:text-blue-600 dark:text-gray-400 dark:hover:text-blue-300 transition-colors duration-200"
              target="_blank"
